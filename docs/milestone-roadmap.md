...
| R1  | Release Gate: Deterministic Frontend Dependencies (pnpm 9.12.3 pin, lockfile regeneration, CI pnpm 9→9.12.3, uv --locked) | ✅ Verified 2026-07-26 — all 4 CI jobs green on master |
