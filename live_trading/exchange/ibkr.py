"""Interactive Brokers stub connector — same pattern as Bybit stub."""
...
class IbkrStubConnector(ExchangeConnector):
    """Stub IBKR connector. Order methods raise NotImplementedError."""
    ...
    async def create_order(
        ...
        msg = "IBKR connector is a stub — real order placement not yet implemented"
        raise NotImplementedError(msg)

    async def cancel_order(self, order_id: str, symbol: str) -> bool:
        msg = "IBKR connector is a stub"
        raise NotImplementedError(msg)
